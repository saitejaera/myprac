...
public class ECommerceAPITest {
	...
	public static void main(String[] args) {
		...
		//giving details of uri
		RequestSpecification req=	new RequestSpecBuilder().setBaseUri("https://rahulshettyacademy.com")
				.setContentType(ContentType.JSON).build();
		
		//giving login details through creating object of other class 
		LoginRequest loginrequest = new LoginRequest();
		loginrequest.setUserEmail("munnasingh1919@gmail.com");
		...
		RequestSpecification reqAddProduct = given().log().all().spec(addProductBaseReq).param("productName", "Laptop")
				...
				.multiPart("productImage",new File("C:/Users/Public/Downloads/computer.jpg"));
